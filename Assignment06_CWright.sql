...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_CWright')
	 Begin 
	  Alter Database [Assignment06DB_CWright] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_CWright;
	 End
	Create Database Assignment06DB_CWright;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_CWright;
...
Select Distinct Top (1000) InventoryDate, EmployeeFirstName, EmployeeLastName
From Inventories
Join Employees
...
E.EmployeeID, E.EmployeeFirstName + ' ' + E.EmployeeLastName As E,
M.EmployeeFirstName + ' ' + M.EmployeeLastName As M
